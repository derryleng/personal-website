  ...
  return (
    <footer id="contact" className="py-8 text-center">
      ...
      <div className="flex items-center justify-center mb-4 space-x-5 text-lg opacity-50">
        ...
        <a
          href="https://github.com/derryleng"
          target="_blank"
          rel="noreferrer noopener"
          className="item-right hover:underline underline-offset-2 decoration-1"
        >
          GitHub
        </a>
        <a
          href="https://www.facebook.com/people/Derry-Leng/pfbid02gn2gU5DPGCHhunCSGU2zwzm2HdhJP3UuoHYNhF48eM5MuEkZjqpxw4pgLCaZ5keNl/"
          target="_blank"
          rel="noreferrer noopener"
          className="hover:underline underline-offset-2 decoration-1"
        >
        ...
        <a
          href="https://www.linkedin.com/in/derry-leng/"
          target="_blank"
          rel="noreferrer noopener"
          className="hover:underline underline-offset-2 decoration-1"
        >
